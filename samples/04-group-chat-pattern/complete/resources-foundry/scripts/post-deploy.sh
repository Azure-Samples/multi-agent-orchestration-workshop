...
pushd "$REPOSITORY_ROOT/samples/04-group-chat-pattern/complete/resources-foundry"
...
dotnet user-secrets --file "$REPOSITORY_ROOT/samples/04-group-chat-pattern/complete/src/MultiAgentWorkshop.PromptAgent/create-agents.cs" set "AZURE_TENANT_ID" $tenantId

dotnet user-secrets --file "$REPOSITORY_ROOT/samples/04-group-chat-pattern/complete/src/MultiAgentWorkshop.PromptAgent/create-agents.cs" set "FOUNDRY_NAME" $foundryName
